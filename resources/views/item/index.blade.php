        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Lists of item</h3>
                <div class="float-right">
                  <a href="{{url('items/create')}}">
                      <button class="btn btn-info">Create Item</button>
                  </a>
                </div>
              </div>
              <!-- /.card-header -->
                  ...
                  <tr>
                    ...
                    <td class="text-center py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="{{url('items/'.$item->id.'/edit')}}" title="Edit">
                          <button class="btn btn-info"> 
                            <i class="fas fa-eye"></i>
                          </button>
                        </a>
                        <form action="{{url('items/'.$item->id)}}" method="post" title="Delete">
                          @csrf
                          @method('DELETE')
                        <button type="submit"
